...
export function assembleChildInstructions(input: ChildInstructionInput): string {
  ...
  return [
    ...
    "- Your final assistant response is the primary result transport. Make it self-contained; include the complete requested deliverable when practical, otherwise a sufficient summary/handoff with exact evidence, changed/inspected files, checks/results, blockers, and remaining work. Do not merely say an artifact was written.",
    "",
    ...
    "- A child-written handoff supplements but never replaces the final assistant response.",
    "",
    "## Final handoff shape",
