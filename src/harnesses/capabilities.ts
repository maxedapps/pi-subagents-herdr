...
export const ADAPTER_CAPABILITIES: Readonly<Record<Harness, AdapterCapabilities>> = Object.freeze({
  pi: Object.freeze({
    ...
    customizationPolicy: "Pi uses normal trust, skill, prompt-template, package, project, and settings resource discovery; child guards still prevent recursive orchestration.",
